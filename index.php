...
<main class="l-main">
    ...
    <section class="p-mainvisual">
        <h2 class="p-mainvisual__title">ハンバーガーショップのダミーサイト</h2>
    </section>
    ...
    <section class="l-main__map p-map">
        <div class="p-map__wrap">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13046.008691578849!2d136.87702724578173!3d35.169034399033535!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!%3A0x81f7204bf8261663!2z5ZCN5Y-k5bGL6aeF!5e0!3m2!1sja!2sjp!4v1631351592153!5m2!1sja!2sjp" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
        </div>

        <!--地図のグレーカラー-->
        <div class="p-map__layer"></div>
        <div class="p-map__content">
            <h3 class="p-map__head">お店の地図</h3>
            <!--疑似要素で横線追加-->
            <p class="p-map__txt">
                当店は〇〇〇駅の△番出口を出て、南のドラックストア方面に向かって３分進んでいただき、左にコンビニエンスストアが見えたら左折してください。お店はすぐ右手にあります。お車でお越しの場合、駐車場はありませんが当店の北側にコインパーキングはありますのでそちらのご利用をお願い致します。テイクアウトの際はお時間を指定いただければ出来るだけお時間通りにご準備させて頂きます。
            </p>
        </div>
